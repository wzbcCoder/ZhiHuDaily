...
//         mHead = (LinearLayout) inflater.inflate(R.layout.lunbo, container, false);
//        mHead1 = (ViewPager) mHead.findViewById(R.id.headviewpager) ;

//         mHead1 = (ViewPager) mHead.findViewById(R.id.headviewpager);
//         mListView.addHeaderView(mHead1);
         return mView;
    }
    @Override
